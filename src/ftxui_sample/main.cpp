...
// configuration step. It creates a namespace called `scoped_new`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", scoped_new::cmake::project_name, scoped_new::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", scoped_new::cmake::project_version);
      return EXIT_SUCCESS;
    }
